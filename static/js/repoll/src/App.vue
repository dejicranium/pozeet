    ...
    <div id="container">
      ...
      <div class="body-container">
        ...
        <div v-if="!loadingMoreContent || loadingMoreContentFailed" style="text-align:center;">
          <button style="font-size:12px;" @click="loadMoreContent">Show More</button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    loadMoreContent: function() {
      ...
      axios
        .get(siteUrl + "/get/latest/?page=" + this.xhrPageId)
        .then(response => {
          this.xhrPageId += 1;
  ...
  created() {
    ...
    var vm = this;
    axios.get(siteUrl + "/get/latest/?page=" + vm.xhrPageId).then(response => {
